...
import { FileOutlined, BookOutlined, SearchOutlined, EllipsisOutlined, SaveOutlined, BlockOutlined, StarOutlined, CommentOutlined } from "@ant-design/icons";
...
const PlanbooksLibraryPage: React.FC = () => {
  ...
  useEffect(() => {
    if (currentPage > 1 && !filteredPlanbooks.slice((currentPage - 1) * pageSize, currentPage * pageSize).length) {
      setCurrentPage(1);
    }
  }, [filteredPlanbooks, currentPage]);
